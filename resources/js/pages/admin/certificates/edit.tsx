...
export default function CertificateEdit({ certificate }: CertificateEditProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        skills: (certificate.skills || []) as string[],
        file: null as File | null,
    });

    const [previewUrl, setPreviewUrl] = useState<string | null>(
        certificate.thumbnail_url || certificate.file_url || null
    );
    ...
    const handleFileChange = (file: File | null) => {
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            setPreviewUrl(certificate.thumbnail_url || certificate.file_url || null);
        }
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(`/admin/certificates/${certificate.id}`, {
            ...
            onError: () => {
                toast.error('Gagal memperbarui sertifikat. Silakan periksa formulir.');
            },
        });
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit Sertifikat', href: `/admin/certificates/${certificate.id}/edit` },
            ]}
        >
            <Head title={`Edit Sertifikat: ${certificate.title} - Ridhwan Studio`} />
                ...
                <div className="flex items-center gap-3.5">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                            Perbarui rincian kelulusan, ID lisensi, atau unggah dokumen terbaru
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 items-start">
                    ...
                    <form onSubmit={handleSubmit} className="lg:col-span-7 space-y-6">
                        <div className="glass-card rounded-[2.2rem] border border-slate-200/70 bg-white/75 p-7 sm:p-8 backdrop-blur-xl shadow-xl shadow-slate-100/50 dark:border-slate-800/80 dark:bg-slate-900/60 dark:shadow-none space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                                    Ganti File Sertifikat (Gambar / PDF)
                                </Label>
                                <ImageUpload
                                    currentImageUrl={certificate.thumbnail_url || certificate.file_url}
                        ...
                        <div className="flex items-center justify-end gap-3">
                            ...
                            >
                                ...
                                {processing ? 'Menyimpan...' : 'Perbarui Sertifikat'}
                            </Button>
                        </div>
                    </form>
