                ...
                <div className="prose prose-slate mt-10 max-w-none space-y-8 text-xs sm:text-sm leading-relaxed text-slate-700 dark:prose-invert dark:text-slate-300">
                    ...
                    <section className="space-y-2">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            ...
                            <li>Memproses transaksi pembayaran aman melalui sistem payment gateway resmi (Midtrans).</li>
                    ...
                    <section className="space-y-2">
                        <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">
                            4. Keamanan Transaksi & Pembayaran (Midtrans)
                        </h2>
                        <p>
                            Kami tidak pernah menyimpan informasi sensitif perbankan (seperti nomor kartu kredit, PIN, atau kata sandi perbankan) di server Kami. Seluruh proses pembayaran dialihkan dan diamankan oleh <strong>Midtrans</strong> menggunakan standar enkripsi perbankan industri terkemuka (PCI-DSS Compliance).
                        </p>
                    </section>
