                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center justify-between border-b border-slate-100/60 bg-white/40 px-6 py-4.5 backdrop-blur-md dark:border-slate-900/60 dark:bg-slate-950/40">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-2xl border border-violet-100/55 bg-white shadow-md dark:border-slate-800 dark:bg-slate-900">
                                    <img
                                        src="/images/ai_avatar_header.png"
                        ...
                        <div className="chat-scroll-container relative z-10 flex-1 space-y-4 overflow-y-auto px-5 py-5">
                                ...
                                >
                                    ...
                                    <div
                                        className={`rounded-2xl border px-4 py-2.5 text-xs leading-relaxed ${
                                            m.sender === 'user'
                                                ? 'via-slate-850 dark:from-violet-650 dark:to-indigo-650 rounded-br-none border-slate-950 bg-gradient-to-tr from-slate-900 to-slate-900 text-white shadow-md shadow-slate-950/5 dark:border-indigo-600 dark:via-indigo-600 dark:shadow-indigo-500/10'
                            ...
                            {isTyping && (
                                <div className="mr-auto flex max-w-[85%] items-end gap-2.5">
                                    <div className="dark:bg-violet-955/20 flex h-7.5 w-7.5 shrink-0 items-center justify-center rounded-xl border border-violet-100/50 bg-violet-50/60 text-violet-600 shadow-sm dark:border-violet-900/30 dark:text-violet-400">
                                        <Bot size={13} />
                                    </div>
                        ...
                        <div className="relative z-10 border-t border-slate-100/60 bg-white p-4.5 dark:border-slate-900/60 dark:bg-slate-950">
                            <div className="border-slate-150/40 dark:border-slate-850 flex items-center gap-2 rounded-2xl border bg-slate-50/60 p-1 dark:bg-slate-900/50">
                                <input
                                    type="text"
                                    value={chatInput}
                                    onChange={(e) =>
...
handleSendMessage();
                                    ...
                                    className="dark:text-slate-105 flex-1 bg-transparent px-3 py-2 text-xs text-slate-900 placeholder-slate-400 outline-none focus:outline-none dark:placeholder-slate-500"
                                />
                                <button
                                    onClick={() => handleSendMessage()}
                                    className="shadow-violet-650/10 flex h-8 w-8 cursor-pointer items-center justify-center rounded-xl border-none bg-violet-600 text-white shadow-md transition-all hover:scale-105 hover:bg-violet-700 active:scale-95"
                                >
                                    <SendHorizontal
                                        size={14}
                                        strokeWidth={2.5}
                            ...
                            <div className="mt-2.5 flex items-center justify-between text-[8px] font-bold text-slate-400 dark:text-slate-500">
                                ...
                                <span className="flex items-center gap-1">
                                    Tekan Enter
                                    <span className="dark:bg-slate-850 flex h-3 w-4 items-center justify-center rounded border border-slate-200 bg-slate-100 text-[8px] dark:border-slate-800">
                                        ↵
                                    </span>
                                </span>
                            </div>
